...
10. copy and paste the url from the search bar https://localhost:7199/
11. paste the URL inside postman. 
12. Open up postman, and once logged in, select the plus button. 
13. New screen will appear, and there will be a new get box where you can paste your url ex; https://localhost:7199/
...
15. https://localhost:7199/SayHola/hello/name
